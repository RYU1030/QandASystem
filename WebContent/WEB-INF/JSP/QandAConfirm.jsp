...
<%@ page
	import="model.Question, model.Answer, java.util.Date, java.util.List"%>
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/QAndAConfirm.css">
	...
	<main>
		...
		<section class="main-outer-wrapper-confirm">
			<div class="main-inner-wrapper-confirm">
					...
					<div class="question-element-row">
						...
						<div class="question-element edit-delete-execute">
							<form name="editDeleteForm" method="POST" action="">
								<p class="registered-key">
									<input type="text" name="edit-delete-key" class="user-input"
				...
				<section class="your-answer-outer-wrapper">
					...
					<form class="answer-form" name="answerForm"
						action="answer?questionId=${question.questionId}" method="POST">
						<div class="your-answer-inner-wrapper">
							<div class="your-answer-element-row">
								...
								<div class="your-answer-element">
									<p>
										<input type="text" class="user-input" name="answerer-name"
											placeholder="名前（ハンドルネーム）"
											value="<% if (answererName != null) { out.println(answererName); } %>">
									</p>
								</div>
							</div>
							<div class="your-answer-element-row">
								...
								<div class="your-answer-element your-answer-content">
									<textarea name="answer-content" cols="30" rows="15"
										placeholder="内容">
										<% if (answerContent != null) { out.println(answerContent); } %>
									</textarea>
								</div>
							</div>
						</div>
		...
		<div class="popup" id="edit-popup">
			<div class="popup-inner">
				<div class="close-btn" id="edit-popup-close-btn">
		...
		<div class="popup" id="delete-popup">
			<div class="popup-inner">
				<div class="close-btn" id="delete-popup-close-btn">
					<i class="fas fa-times"></i>
				</div>
				<div class="request-confirmation">
					<p>削除します。よろしいですか。</p>
		...
		<div class="popup" id="send-answer-popup">
			<div class="popup-inner">
				<div class="close-btn" id="send-answer-popup-close-btn">
					<i class="fas fa-times"></i>
				</div>
				<div class="request-confirmation">
