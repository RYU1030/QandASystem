...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/QandAList.css">
<link rel="stylesheet"
			...
			<div class="top-message-wrapper">
				<div class="top-message-inner-wrapper">
					<h1 class="top-message">
						一人で悩まず、<br>誰かに質問してみよう:)
					</h1>
					<p class="ask-questions">
						<a class="action-btn" href="regist">質問する</a>
					</p>
				</div>
			</div>
		</section>
			...
			<table class="questions-list">
				...
				<c:forEach var="question" items="${questionList}">
					<tr>
						...
						<td style="width: 450px;"><a
							href="confirm?questionId=${question.questionId}"><c:out
									value="${question.title}" /></a></td>
						<td style="width: 200px;"><c:out
								value="${question.handleName}" /></td>
