	...
	<main>
		...
		<section class="main-outer-wrapper-common">
					...
					<div class="question-element-row">
						...
						<div class="question-element">
							<p class="questioner-name">
								<input name="questioner-name" type="text" class="user-input"
									placeholder="名前（ハンドルネーム）" value="${question.handleName}">
							</p>
						</div>
					</div>
					<div class="question-element-row">
						...
						<div class="question-element">
							<p class="question-title">
								<input name="question-title" type="text" class="user-input"
									placeholder="タイトル" value="${question.title}">
							</p>
						</div>
					</div>
					<div class="question-element-row">
						...
						<div class="question-element">
							<textarea name="question-content" class="question-content"
								cols="30" rows="15" placeholder="内容">${question.contents}</textarea>
						</div>
					</div>
						...
						<div class="question-element urgency-levels-user-input">
							<p class="urgency">
								<label for="urgent"><input type="radio" name="urgency"
									value=1 id="urgent" <% if (urgency == 1) { %> checked="checked"
									<% } %>>急いでいます</label>
							</p>
							<p class="urgency">
								<label for="advisable"><input type="radio"
									name="urgency" value=2 id="advisable" <% if (urgency == 2) { %>
									checked="checked" <% } %>>困っています</label>
							</p>
							<p class="urgency">
								<label for="anytime"><input type="radio" name="urgency"
									value=3 id="anytime" <% if (urgency == 3) { %>
									checked="checked" <% } %>>いつでも</label>
							</p>
						</div>
					</div>
					<div class="question-element-row">
						...
						<div class="register-cancel">
							<p class="register-cancel-key">
								<input name="edit-delete-key" type="text" class="user-input"
			...
			<div class="register-cancel-execute">
				...
				<p class="cancel-btn">
					<a class="action-btn"
						href="confirm?questionId=${question.questionId}">キャンセル</a>
				</p>
			</div>
		</section>
